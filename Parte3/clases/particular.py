...
class Particular(Automovil):
    ...
    def __dic__(self):
        return {'marca': self._marca, 'modelo': self._modelo, 'num_ruedas': self._num_ruedas, 'velocidad':self._velocidad, 'cilindradas':self._cilindradas, 'num_puestos': self.get_num_puestos()}